                    ...
                    if (key.equals("selected")) {
                        ...
                        logTag =
                                sharedPreferences.getString(
                                        key, getResources().getString(R.string.pref_logTag));
                    } else if (key.equals("logOnPress")) {
                        logOnPress =
                                sharedPreferences.getString(
                                        key, getResources().getString(R.string.pref_logOnPress));
                    } else if (key.equals("logShortPress")) {
                        logShortPress =
                                sharedPreferences.getString(
                                        key, getResources().getString(R.string.pref_logShortPress));
                    } else if (key.equals("logLongPress")) {
                        logLongPress =
                                sharedPreferences.getString(
                                        key, getResources().getString(R.string.pref_logLongPress));
                        ...
                        switch (dimMode) {
                            ...
                            case DIM_MODE_AUTO:
                                if (sunriseSunset.getLocation() == null) {
                                    sunriseSunset =
                                            new SunriseSunset(context, sunriseSunsetCallbacks);
                                }
    ...
    private Utils.UtilCallbacks utilCallbacks =
            new Utils.UtilCallbacks() {
                ...
                public void onException(Throwable e) {
                    Toast.makeText(context, "Error occured: " + e.getMessage(), Toast.LENGTH_LONG)
                            .show();
                }
            };
